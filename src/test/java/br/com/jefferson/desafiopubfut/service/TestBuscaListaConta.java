...
class TestBuscaListaConta {
	...
	void testListarContas() {
		List<Conta> listaTeste = new ArrayList<Conta>();
		listaTeste = contaService.buscarContas();
		int i = 1;
		for (Conta conta : listaTeste) {
			assertEquals(i, conta.getId_conta());
			i++;
		}
	}
